...
מדובר בגרף מסוג Q-Q Plot (Quantile-Quantile Plot),  
...
בגלל שהגרלת את המספרים מתוך התפלגות נורמלית סטנדרטית:
\[
\mathcal{N}(0, 1)
\]
...
## מה זה Ordered Values?

"Ordered" = ממויין.  
הכוונה היא שהנתונים שלך **סודרו מהקטן לגדול**, לפני שמחשבים את הקוונטילים שלהם.  
זה חלק חשוב מתהליך בניית גרף Q-Q.

## סיכום

Q-Q Plot הוא דרך גרפית לבדוק אם הדגימה שלך נראית כמו התפלגות נורמלית.  
