...
### השוואה בין Porter ל־Snowball – דוגמה והסבר
...
Porter Stemmer פשוט מקצר סיומות לפי כללים קבועים בלי להבין את משמעות המילה
במקרה של `fairly`, הוא מוריד רק את `-ly` אבל לא ממשיך הלאה ולכן נשאר עם `fairli` – שהוא לא באמת מילה נכונה

#### למה Snowball מחזיר `fair`

Snowball Stemmer הוא גרסה חכמה יותר
הוא לוקח בחשבון הקשר לשוני רחב יותר ומכיל חוקים מורחבים שמזהים גם קונסטרוקציות נפוצות כמו `-ly`
