...
Single Linkage מסתכל רק על **המרחק הכי קצר בין שתי קבוצות**  
...
Complete Linkage עושה את ההפך מ־Single – הוא מסתכל על **המרחק הכי רחוק** בין כל זוג של נקודות – אחת מכל קבוצה  
...
Average Linkage מחשבת את כל המרחקים האפשריים בין נקודות של שתי קבוצות – ולוקחת את **הממוצע**  
זו שיטה "מאוזנת" בין Single ל־Complete
