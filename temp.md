...
5. ## 🧠 איך קרנל משיג את אותה תוצאה מבלי לחשב את הטרנספורמציה?

---

### 🎯 הבעיה:

לפעמים הקבוצות לא ניתנות להפרדה בעזרת קו ישר (כלומר לא ניתנות להפרדה ליניארית).  
אז היינו רוצים להעביר את הנתונים ל**מרחב גבוה יותר** בעזרת טרנספורמציה, שבו כן נצליח להפריד עם קו ישר.

אבל... לבצע טרנספורמציה בפועל (כלומר לחשב את הערכים של הפונקציה) זה קשה ויקר חישובית.
