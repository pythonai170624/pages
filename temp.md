...
### ✅ \( y_i \) הוא התווית (label) של הדוגמה ה־\( i \)

לכל דוגמה \( x_i \), יש תווית \( y_i \) שמציינת לאיזו מחלקה היא שייכת:

- \( y_i = +1 \) → הדוגמה שייכת למחלקה החיובית  
- \( y_i = -1 \) → הדוגמה שייכת למחלקה השלילית 
