...
Print sample row:
```
{'are': 0.2524422607133928, 'going': 0.3230441330419753, 'make': 0.36308344981075574, 'me': 0.22163671451015382, 'moan': 0.5328892367086496, 'princess': 0.44029157228894206, 'to': 0.15576398008518208, 'yes': 0.35100930940159797, 'you': 0.1602042707313863}
```
...
כי גם מטריצת ה־TF-IDF מבוססת על אותה קבוצת אימון:
- 3900 מסמכים (הודעות)
- 7245 מילים ייחודיות

רק שעכשיו המספרים בתוך המטריצה הם **ציונים משוקללים**, לא רק ספירות
