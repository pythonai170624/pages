...
השלבים של **קיי מינס**:
1. **אתחול** – בוחרים את מספר הקבוצות K וממקמים נקודות התחלתיות באופן אקראי
2. **שיוך** – כל נקודה בדאטה משויכת למרכז הקרוב ביותר על פי **מרחק אוקלידי**
3. **עדכון מרכזים** – מחשבים מחדש את מיקום כל מרכז כ**ממוצע** של כל הנקודות בקבוצה
4. **שיוך מחדש** – מחשבים מחדש את הקרבה של כל נקודה למרכזים ומעדכנים אם צריך
5. **חזרה** – חוזרים על השלבים עד שאין שינוי או שהגענו למספר איטרציות מרבי
