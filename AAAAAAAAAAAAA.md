...
<img src="cnn_layers.png" align="right" style="width:300px"/>
...
3. **פונקציית הפעלה (למשל ReLU)** → מוסיפה לא־לינאריות לרשת ומסייעת לסנן ערכים לא חשובים
...
ReLU (Rectified Linear Unit) היא אחת מפונקציות ההפעלה הנפוצות ביותר ברשתות נוירונים עמוקות
...
* **מוסיפה לא־לינאריות לרשת** – מאפשרת ללמוד תבניות מורכבות, לא רק חישובים ישרים
* **מסננת ערכים לא רלוונטיים** – מוחקת ערכים שליליים שנחשבים כרעש או תוצאה של מאפיינים לא חשובים
* **עוזרת להימנע מ־Vanishing Gradient** – בעיה שבה הגרדיאנטים נהיים קטנים מדי ברשת עמוקה
...
אם המפה לא מתחלקת בדיוק, מתעלמים מהשוליים או מטפלים בהם בנפרד
