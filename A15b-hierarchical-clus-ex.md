...
לדוגמה: אם קבוצת שורות מסוימת צבועה צהוב ב־ פאטל_לאנגס ואחרת כהה – זה אומר שזה מאפיין שמפריד ביניהן

- אתה יכול לבדוק **כמה טארגט (אם יש)** באמת מתיישב על הקלאסטרים שמצאת – ולראות כמה "הגיוני" החלוקה שגילית
