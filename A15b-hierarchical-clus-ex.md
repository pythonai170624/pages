...
- אתה יכול לראות **קבוצות ברורות של פרחים** – גם אם לא כתוב לך מי מהן זה סטוסה, ורסיקולור וכו'  
  ...
  1. הקבוצות מופיעות כשורות **צמודות** שיש להן **דפוס צבעים דומה** לאורך כל העמודות  
     לדוגמה: 6–8 שורות שיש להן גוונים דומים מאוד – כנראה משתייכות לאותו קלאסטר

  2. **הדנדרוגרמה בצד שמאל** מחזקת את זה – אם הענפים של שורות מסוימות מתחברים **נמוך בעץ**, זה אומר שהן מאוד דומות זו לזו
...
- אתה רואה **איזה מאפיינים מבדילים בין הקבוצות**  
  לדוגמה: אם קבוצת שורות מסוימת צבועה צהוב ב־`petal length` ואחרת כהה – זה אומר שזה מאפיין שמפריד ביניהן

- אתה יכול לבדוק **כמה target (אם יש)** באמת מתיישב על הקלאסטרים שמצאת – ולראות כמה "הגיוני" החלוקה שגילית
