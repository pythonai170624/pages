...
המודל עובר שוב ושוב על כל מילה בכל מסמך, ומחשב מהו השיוך הכי מתאים שלה לנושא (Topic)

בכל איטרציה, הוא שואל שתי שאלות:

כמה פעמים מילה זו הופיעה בכל Topic עד עכשיו?  
→ האם המילה נפוצה יותר ב־Topic מסוים?

כמה Topic מסוים נפוץ במסמך הזה?  
→ האם המסמך כבר מכיל מילים רבות מאותו Topic?

המילה תקבל הסתברות לכל Topic לפי שני הדברים האלו, והמודל יעדכן את השיוך שלה בהתאם
