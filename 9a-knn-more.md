...
- אם שכן נמצא קרוב מאוד (למשל d = 0.1) אז 1/d = 10 → השפעה גדולה  
- אם שכן רחוק (למשל d = 10) אז 1/d = 0.1 → השפעה קטנה  
- זה יוצר יחס **הפוך** בין מרחק להשפעה בדיוק כמו שאנחנו רוצים

### דוגמה מהתמונה

- תפוחים: 1/d = 1 + 0.5 = 1.5  
- תפוזים: 1/d = 0.33 + 0.25 = 0.58

למרות שיש שני תפוחים ושני תפוזים  
ה־תפוחים יותר קרובים ולכן משפיעים יותר  
ולכן הפרי החדש יסווג כ־🍎

### סיכום

- סכום מרחקים נותן משקל **לרחוקים** בטעות  
- 1/d הופך את זה כך ש־**קרובים יותר = חשובים יותר**  
- זו הדרך הנכונה לתת עדיפות לשכנים קרובים
