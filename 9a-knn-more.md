...
2. **שקלול לפי מרחק**: במקום לתת לכל שכן משקל זהה, נשקלל את הקבוצה של הנקודה לפי 1/d, כאשר d הוא המרחק מהנקודה החדשה. כך, שכנים קרובים יותר מקבלים השפעה גדולה יותר:

$$\text{משקל השכן} = \frac{1}{d(x, x_i)}$$

דוגמה מספרית – מה זה \( \frac{1}{d} \)

נניח שהשתמשנו ב-K=4 והשכנים הקרובים ביותר לפרי חדש הם:

| שכן | קטגוריה | מרחק מהפרי החדש | משקל \( \frac{1}{d} \) |
|------|----------|------------------|-------------------------|
| 1    | תפוח 🍎   | 1.0              | 1.00                    |
| 2    | תפוח 🍎   | 2.0              | 0.50                    |
| 3    | תפוז 🍊   | 3.0              | 0.33                    |
