...
PCA בוחר את הכיוון שבו ההקרנות של כל הנקודות הכי שונות אחת מהשנייה  
כלומר יש שם הכי הרבה מידע


### מתמטית

PCA מחשב וקטורים עצמיים (eigenvectors) מתוך מטריצת קו־וריאנס של הדאטה  
כל וקטור כזה מייצג רכיב עיקרי  
כל הוקטורים יחד יוצרים בסיס חדש לדאטה – בסיס אורתונורמלי  
כלומר הם גם מאונכים זה לזה וגם באורך 1
