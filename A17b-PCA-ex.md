...
- **PC2**: הציר השני בחשיבותו, מאונך ל-PC1. הוא מייצג שונות נוספת שאינה מוסברת על ידי PC1

**🔍 מה רואים בגרף?**

- כל נקודה מייצגת שורה אחת (תצפית) בדאטה המקורי, לאחר שהוקרנה על הצירים החדשים
- רוב הנקודות מרוכזות סביב המרכז (0,0), מה שמעיד על ממוצע נורמלי לאחר נרמול
