...
> 
#### שלב 1: נחשב את ההסתברויות (p-hat)

הנוסחה לחיזוי הסתברות:
...
#### שלב 2: נחשב את הנגזרת של פונקציית הלוג־לייקלי לפי β₀
...
- אם הנגזרת לא הייתה 0, היינו מעדכנים את β₀ לפי:

$$
\beta_0 = \beta_0 - \text{learning\_rate} \cdot \left( \frac{\partial \log L}{\partial \beta_0} \right)
$$
...
אם הנגזרת הייתה חיובית – המשמעות היא שהמודל **טעה פחות מדי** ולכן צריך להוריד את β₀.  
אם היא שלילית – צריך להגדיל את β₀.  
אבל בגלל שיש מינוס בנוסחת העדכון, זה קורה אוטומטית נכון.
